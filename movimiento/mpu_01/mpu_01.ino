...
Average<float> avgX(100);
Average<float> avgY(100);
Average<float> avgZ(100);
...
//            Serial.println(aaWorld.z);
            ...
            int x = int(round(avgX.mean()));
            int y = int(round(avgY.mean()));
            int z = int(round(avgZ.mean()));
        
            int r = round(sqrt(pow(x, 2) + pow(y, 2) + pow(z, 2)));
